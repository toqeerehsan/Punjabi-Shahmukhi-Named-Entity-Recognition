...
history = model.fit([train_sentences_X, train_chars_X, train_pos_tags_X], to_categorical(train_tags_y, len(tag2index)), batch_size=128, epochs=16, validation_data=([dev_sentences_X,dev_chars_X,dev_pos_tags_X], to_categorical(dev_tags_y, len(tag2index))), shuffle = True)
