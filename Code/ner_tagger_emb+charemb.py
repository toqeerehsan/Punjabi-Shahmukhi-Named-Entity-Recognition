...
#file= open("data/punjabi_elmo_vocab.txt","w")
...
#main_LSTM3= Bidirectional(LSTM(300, return_sequences=True, recurrent_dropout=0.5))(dropout3)
#dropout4= Dropout(0.2)(main_LSTM3)
...
history = model.fit([train_sentences_X, train_chars_X], to_categorical(train_tags_y, len(tag2index)), batch_size=128, epochs=15, validation_data=([dev_sentences_X,dev_chars_X], to_categorical(dev_tags_y, len(tag2index))), shuffle = True)
